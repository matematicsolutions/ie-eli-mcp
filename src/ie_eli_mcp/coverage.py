...
_FAMILIES: list[dict] = [{'name': 'Acts and statutory instruments (enacted text)', 'tool': 'ie_get_act / ie_get_text'}]

_GAPS: list[dict] = [{'id': 'IE-001', 'family': 'Acts and statutory instruments (enacted text)', 'missing': 'Enacted text only - revised (consolidated) versions live separately and are not covered here.', 'fallback': 'Use the Revised Acts section of the Irish Statute Book.'}, {'id': 'IE-002', 'family': 'Acts and statutory instruments (enacted text)', 'missing': 'Discovery is by coordinates only; this source has no keyword-search API.', 'fallback': 'Use the Irish Statute Book website search to find a year and number.'}, {'id': 'IE-003', 'family': 'Acts and statutory instruments (enacted text)', 'missing': 'Legal force on a given date is not evaluated. Text is returned as the source publishes it; this connector does not decide whether a provision is in force.', 'fallback': 'Check the validity or consolidation dates on the source record itself.'}]
